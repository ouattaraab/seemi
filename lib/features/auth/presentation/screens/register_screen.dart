...
/// Écran d'inscription — saisie du numéro de téléphone (+225).
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _onSendCode() async {
    ...
    if (authProvider.verificationId != null) {
      context.go(RouteNames.kRouteOtp, extra: {'phoneNumber': phoneNumber, 'isLoginFlow': false});
    }
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    height: AppSpacing.kSpace2xl,
                    child: FilledButton(
                      onPressed: authProvider.isLoading ? null : _onSendCode,
